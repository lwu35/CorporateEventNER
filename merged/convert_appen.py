...
please_select_the_event_type = df['please_select_the_event_type'].tolist()
...
select_fiscal_year = df['select_fiscal_year'].tolist()

enter_date_here_mmddyyyy = df['enter_date_here_mmddyyyy'].tolist()

enter_time_here_hhmm_pmam = df['enter_time_here_hhmm_pmam'].astype(str).str.replace('\n', ' ').tolist()

select_timezone = df['select_timezone'].tolist()
