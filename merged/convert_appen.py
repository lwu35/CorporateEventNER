...
dict = {'id': ids, 'event_text': event_text, 'url': url, 'url_id': url_id, 'company': copy_the_company_name_from_the_text, 'fiscal_year': select_fiscal_year,
        'fiscal_period': select_the_fiscal_period_check_as_many_as_it_applies, 'event_type': please_select_the_event_type, 'date': converted_date, 'time': enter_time_here_hhmm_pmam, 'timezone': select_timezone}
